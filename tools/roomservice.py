...
custom_local_manifest = ".repo/local_manifests/mokp_manifest.xml"
custom_default_revision = "mm6.0"
custom_dependencies = "mokp.dependencies"
org_manifest = "MOKP"  # leave empty if org is provided in manifest
org_display = "MOKP"  # needed for displaying
